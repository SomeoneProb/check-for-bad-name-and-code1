...
badNames = [
    ...
    "TNIGGER", "BNIGGER", "FUCKYOURSELF", "shit",
    "FUCK", "FUCKYOU", "FUCKINGNIG", "NI55A", "NIG5A", "NI5GA", "PENIS", "KILLYOURSEL", "FUCKINGNIGA", 
    ...
    "NIGYR", "NIGBIGGER", "NIGCKER", "NIGIR", "NIG33R", "KXK", "KKX", "XXK", "KXX" # add more if needed lol
]
